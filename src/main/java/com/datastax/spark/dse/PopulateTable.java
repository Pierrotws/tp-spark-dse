...
// dse spark-submit --class com.datastax.spark.dse.PopulateTable tp-spark-dse-*.jar
public class PopulateTable {
  public static void main(String[] args) {
    ...
    JavaRDD<Tuple2<Integer, Integer>> data = spark
      ...
      .javaRDD() // fix java
    //(1,9) , (2,8), etc....
      .map(x -> new Tuple2<>(x.intValue(), 10 - x.intValue())); // RDD[Int] => RDD[Tuple2]

    //Renvoyer la data au driver, puis l'afficher sur la console
